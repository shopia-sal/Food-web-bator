...
import AyamPenyet from "./AyamPenyet.png";
import RisolMayo from "./RisolMayo.png";
import SateKacang from "./SateKacang.png";
import NasiUduk from "./NasiUduk.png";
...
export const aboutfeature = [
    { icon: FaBolt, title: "Pemesanan Instan", text: "Nikmati Digital Tanpa Hambatan", color: "from-amber-400 to-orange-500" },
    { icon: FaRegClock, title: "Selalu Buka", text: "Layanan Premium 24 Jam", color: "from-rose-400 to-pink-600" },
    { icon: FaCalendarCheck, title: "Pemesanan Eksklusif", text: "Reservasi Prioritas", color: "from-emerald-400 to-cyan-600" },
    { icon: FaFire, title: "Hidangan Khas", text: "Hidangan Istimewa Chef", color: "from-purple-400 to-indigo-600" }
];

// SPECIAL MENU
export const cardData = [
    { id: 1, title: 'Ayam Penyet', rating: 4.5, hearts: 105, description: 'Ayam renyah dengan sambal pedas menggoda.', image: AyamPenyet, popular: true, price: '15k' },
    { id: 2, title: 'Risol Mayo', rating: 5.0, hearts: 155, description: 'Risol mayo renyah dengan saus creamy.', image: RisolMayo, bestseller: true, price: '3k' },
    { id: 3, title: 'Sate Kacang', rating: 4.2, hearts: 85, description: 'Potongan daging juicy, dilumuri saus kacang autentik.', image: SateKacang, price: '25k' },
    { id: 4, title: 'Nasi Uduk', rating: 4.8, hearts: 285, description: 'Nasi gurih harum santan dengan lauk lengkap menggugah selera.', image: NasiUduk, special: true, price: '13k' },
];
...
export const bannerAssets = {
    ...
    orbitImages: [Image1, Image2],
    video: Video,
};

// dummyData.js
export const addButtonBase = 
  "relative flex items-center gap-2 px-4 py-2 bg-amber-600 rounded-xl font-bold uppercase tracking-wide";
