...
// Reducer untuk mengatur perubahan state cart
...
// Inisialisasi data cart dari localStorage
const initializer = () => {
  try {
...
export const CartProvider = ({ children }) => {
  ...
  // Ambil data cart dari server saat komponen pertama kali di-render
  useEffect(() => {
...
// Hook untuk memanggil cart context di komponen lain
